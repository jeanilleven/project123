...
export default {
  sidebarMenu: [
    ...
    {accountType: 'MARKETING', showOnAdmin: true, accountStatus: 'MARKETING', description: 'Coupons', icon: 'fas fa-stamp', path: 'coupons', flag: false, subMenu: null},
    {accountType: 'MARKETING', showOnAdmin: true, accountStatus: 'MARKETING', description: 'Transfer Charges', icon: 'fas fa-stamp', path: 'transfer_charges', flag: false, subMenu: null},
    {accountType: 'MARKETING', showOnAdmin: true, accountStatus: 'MARKETING', description: 'Resolution Tickets', icon: 'fas fa-bug', path: 'tickets', flag: false, subMenu: null},
    {accountType: 'ACCOUNTANT', showOnAdmin: true, accountStatus: 'ACCOUNTANT', description: 'Coupons', icon: 'fas fa-stamp', path: 'adminWithdrawals', flag: false, subMenu: null},
