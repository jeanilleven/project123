...
export default {
  sidebarMenu: [
    ...
    {accountType: 'ADMIN', showOnAdmin: true, accountStatus: 'ADMIN', description: 'Ledgers', icon: 'fas fa-piggy-bank', path: 'adminDeposits', flag: false, subMenu: null},
    ...
    {accountType: 'ACCOUNTANT', showOnAdmin: false, accountStatus: 'ACCOUNTANT', description: 'Ledgers', icon: 'fas fa-piggy-bank', path: 'adminDeposits', flag: false, subMenu: null},
